...
public class RegStepDef {
	...
	public void openBrowsser() {
		String driverPath = "D:\\126_Anup_Banerjee\\BDDCucumberSelenium\\chromedriver.exe";
		System.setProperty("webdriver.chrome.driver", driverPath);	
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		rpg = new RegPageFactory(driver);

		driver.get("D:\\126_Anup_Banerjee\\BDDCucumberSelenium\\SetB\\ConferenceRegistartion.html");
	}
